...
\includepdf{images/のな表紙.pdf}
%%\includegraphics[width=\paperwidth]{images/KOKORO100.png}
%% \includegraphics[width=\paperwidth]{のな表紙.png}
...
\begin{tabular}{ll}
  2016/12/29 & 初版発行\\
  hash: & \href{https://github.com/nna774/C91book/commit/36fdbd1550f6ccdc7b9233c115dfecdec1cb0c54}{36fdbd1550f6ccdc7b9233c115dfecdec1cb0c54}(の次)\\
...
今回表紙はMokoさん(\href{https://twitter.com/moko_oxygen}{@moko\_oxygen})に描いて頂きました！
ありがとうございました。

%% \newpage
%% 　
%% \newpage
\includepdf{images/描画.pdf}
